...
?>
      ...
      <?= Html::beginForm(['apis/searchapi'], 'post', ['data-pjax' => '','id' => 'selectform','class' => 'form-inline']); ?>
            ...
            ['layer-title' => 'Display Title', 'layer-description' => 'Description',
            'layer-nameorurl' => 'Service URL', 'layer-externalid' => ' Service Layer Name ',
            'layer-date' => 'Date'
            ],
            ['id' => 'selectfield'])
             ?>
             ...
             <?=  Html::hiddenInput('view', '_layerjsonview') ?>
